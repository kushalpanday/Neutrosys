    ...
    <div>
      ...
      <div className="coregrid">
        <div className="valuetext1">
          ...
          <p>
            this is text 1 Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Omnis eius rerum repellendus, expedita numquam tenetur minus
            aliquid! Qui obcaecati officia maiores placea
          </p>
        </div>
<div className="line">
  <hr />
        ...
        <div className="valuetext2">
          <img className="icon2" src="../Aboutimage/cs3.png" alt="" />
          {/* <hr
        className="line"
        style={{
           color: "blue",
      ...
      /> */}
          ...
          <p>
            ...
            dolor sit amet consectetur adipisicing elit. Omnis eius rerum
            repellendus, expedita numquam tenetur minus aliquid! Qui obcaecati
            officia maiores placeadipisicing elit
          </p>
        </div>
        <div className="line">
          <hr />
        ...
        <div className="valuetext3">
          <img className="icon3" src="../Aboutimage/cs1.png" alt="" />
          <h3>Strong bond</h3>
          <p>
